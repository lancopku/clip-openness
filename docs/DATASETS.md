...
- Create `images/` under `cifar10/`.
- Download the dataset from the [Website](https://github.com/knjcode/cifar2png) and extract the training and test sets to `$DATA/cifar10/images`. The directory structure should look like
```
cifar10/
|–– images/
...
- Create `images/` under `cifar100/`.
- Download the dataset from the [Website](https://github.com/knjcode/cifar2png) and extract the training and test sets to `$DATA/cifar100/images`. The directory structure should look like
```
cifar100/
|–– images/
